...
#include "rosidl_runtime_c/primitives_sequence.h"  // cooccurrences
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // cooccurrences
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: cooccurrences
  {
    size_t size = ros_message->cooccurrences.size;
    auto array_ptr = ros_message->cooccurrences.data;
    cdr << static_cast<uint32_t>(size);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: cooccurrences
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->cooccurrences.data) {
      rosidl_runtime_c__float__Sequence__fini(&ros_message->cooccurrences);
    }
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->cooccurrences, size)) {
      fprintf(stderr, "failed to create array for field 'cooccurrences'");
      return false;
    }
    auto array_ptr = ros_message->cooccurrences.data;
