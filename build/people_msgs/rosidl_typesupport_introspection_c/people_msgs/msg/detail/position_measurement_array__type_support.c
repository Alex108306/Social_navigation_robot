...
size_t people_msgs__msg__PositionMeasurementArray__rosidl_typesupport_introspection_c__size_function__PositionMeasurementArray__cooccurrences(
  const void * untyped_member)
{
...
const void * people_msgs__msg__PositionMeasurementArray__rosidl_typesupport_introspection_c__get_const_function__PositionMeasurementArray__cooccurrences(
  const void * untyped_member, size_t index)
{
  const rosidl_runtime_c__float__Sequence * member =
    (const rosidl_runtime_c__float__Sequence *)(untyped_member);
...
void * people_msgs__msg__PositionMeasurementArray__rosidl_typesupport_introspection_c__get_function__PositionMeasurementArray__cooccurrences(
  void * untyped_member, size_t index)
{
...
void people_msgs__msg__PositionMeasurementArray__rosidl_typesupport_introspection_c__fetch_function__PositionMeasurementArray__cooccurrences(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const float * item =
    ((const float *)
    people_msgs__msg__PositionMeasurementArray__rosidl_typesupport_introspection_c__get_const_function__PositionMeasurementArray__cooccurrences(untyped_member, index));
  float * value =
    (float *)(untyped_value);
  *value = *item;
}

void people_msgs__msg__PositionMeasurementArray__rosidl_typesupport_introspection_c__assign_function__PositionMeasurementArray__cooccurrences(
  void * untyped_member, size_t index, const void * untyped_value)
{
  float * item =
    ((float *)
    people_msgs__msg__PositionMeasurementArray__rosidl_typesupport_introspection_c__get_function__PositionMeasurementArray__cooccurrences(untyped_member, index));
  const float * value =
    (const float *)(untyped_value);
  *item = *value;
}

bool people_msgs__msg__PositionMeasurementArray__rosidl_typesupport_introspection_c__resize_function__PositionMeasurementArray__cooccurrences(
  void * untyped_member, size_t size)
{
  rosidl_runtime_c__float__Sequence * member =
    (rosidl_runtime_c__float__Sequence *)(untyped_member);
...
static rosidl_typesupport_introspection_c__MessageMember people_msgs__msg__PositionMeasurementArray__rosidl_typesupport_introspection_c__PositionMeasurementArray_message_member_array[3] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(people_msgs__msg__PositionMeasurementArray, cooccurrences),  // bytes offset in struct
    NULL,  // default value
    people_msgs__msg__PositionMeasurementArray__rosidl_typesupport_introspection_c__size_function__PositionMeasurementArray__cooccurrences,  // size() function pointer
    people_msgs__msg__PositionMeasurementArray__rosidl_typesupport_introspection_c__get_const_function__PositionMeasurementArray__cooccurrences,  // get_const(index) function pointer
    people_msgs__msg__PositionMeasurementArray__rosidl_typesupport_introspection_c__get_function__PositionMeasurementArray__cooccurrences,  // get(index) function pointer
    people_msgs__msg__PositionMeasurementArray__rosidl_typesupport_introspection_c__fetch_function__PositionMeasurementArray__cooccurrences,  // fetch(index, &value) function pointer
    people_msgs__msg__PositionMeasurementArray__rosidl_typesupport_introspection_c__assign_function__PositionMeasurementArray__cooccurrences,  // assign(index, value) function pointer
    people_msgs__msg__PositionMeasurementArray__rosidl_typesupport_introspection_c__resize_function__PositionMeasurementArray__cooccurrences  // resize(index) function pointer
  }
};
