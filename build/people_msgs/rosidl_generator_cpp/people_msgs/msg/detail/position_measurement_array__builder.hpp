...
class Init_PositionMeasurementArray_cooccurrences
{
public:
  explicit Init_PositionMeasurementArray_cooccurrences(::people_msgs::msg::PositionMeasurementArray & msg)
  : msg_(msg)
  {}
  ::people_msgs::msg::PositionMeasurementArray cooccurrences(::people_msgs::msg::PositionMeasurementArray::_cooccurrences_type arg)
  {
    msg_.cooccurrences = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_PositionMeasurementArray_cooccurrences people(::people_msgs::msg::PositionMeasurementArray::_people_type arg)
  {
    msg_.people = std::move(arg);
    return Init_PositionMeasurementArray_cooccurrences(msg_);
  }
